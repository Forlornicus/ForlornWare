...
LUAI_FUNC std::map<Closure*, bool> luaF_getclosures();
LUAI_FUNC void luaF_clearclosures();
LUAI_FUNC void luaF_replacelclosure(lua_State* L, Closure* closure, Closure* newclosure);
LUAI_FUNC void luaF_replacecclosure(lua_State* L, Closure* closure, Closure* newclosure);
